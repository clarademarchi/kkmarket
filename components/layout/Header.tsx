          ...
          <div className="flex items-center gap-3">
            ...
            {user && (
              <Link 
                ...
                className="relative flex h-10 w-10 items-center justify-center rounded-md text-[var(--gm-ink-dim)] hover:text-[var(--gm-ink)] hover:bg-[var(--gm-paper-3)] transition-colors"
                title="Mensagens"
              >
